        ...
        <div class="content-header-section">
            ...
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu dropdown-menu-right min-width-200"
                    ...
                    <h5 class="h6 text-center py-10 mb-5 border-b text-uppercase">{{ $name }}</h5>
                    <a class="dropdown-item" href="{{ route('account.info.edit') }}">
                        <i class="si si-user mr-5"></i> Mon compte
                    </a>
                    <a class="dropdown-item" href="{{ route('account.password.edit') }}">
                        <i class="si si-wrench mr-5"></i> Mot de passe / Configurations
                    </a>
                    ...
                    <!-- Toggle Side Overlay -->
                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                    {{-- <a class="dropdown-item" href="{{route('account.password.edit')}}" data-toggle="layout"
