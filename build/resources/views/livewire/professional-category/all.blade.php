                    ...
                    <table class="table table-striped table-vcenter">
                        <thead>
                            <tr>
                                ...
                                <th>Libelle catégorie professionnelle</th>
                                <th>Statut</th>
                        ...
                        <tbody>
                            @foreach ($professionalCategories as $professionalCategory)
                                <tr>
                                    <td>{{ "$professionalCategory->wording" }}</td>
                                    <td>
                                        @if ($professionalCategory->state)
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            {{-- <a href="{{route('professional-categories.show', $professionalCategory)}}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Modifier ce profile utilisateur">
                                            ...
                                            <a href="{{ route('professional-categories.edit', $professionalCategory) }}"
                                            ...
                                            <button type="button" class="btn btn-sm btn-secondary"
                                                ...
                                                data-target="{{ "#profCatModal$professionalCategory->id" }}">
                                                <i class="fa fa-times" aria-hidden="true"></i><br>
                                                Supprimer
                                            </button>
                                            <div class="modal fade" id="{{ "profCatModal$professionalCategory->id" }}"
                                                tabindex="-1" aria-labelledby="{{ "profCatModalLabel$professionalCategory->id" }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('professional-categories.destroy', $professionalCategory) }}"
                                                                onclick="event.preventDefault(); document.getElementById('deleted-profcat-{{ $professionalCategory->id }}').submit();"
                                                                class="btn btn-danger">Supprimer</a>
                                                            <form id="deleted-profcat-{{ $professionalCategory->id }}"
                                                                action="{{ route('professional-categories.destroy', $professionalCategory) }}"
                            ...
                            @endforeach
                            @if (count($professionalCategories) <= 0)
                                <tr>
