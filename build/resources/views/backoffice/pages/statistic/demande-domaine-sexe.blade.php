...
@section('content')
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="content-heading">Répartition des demandes de visa enregistrées par domaine de qualification et par sexes</h2>
            </div>
        </div>
        <div class="block">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form method="Post" action="{{route('statistics.fetch.demands.domaine.sexe')}}">
                                @csrf
                                <div class="row">
            ...
            <div class="row">
                @if ($isFetch)
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <form id="export-excel-branche-sexe-export" action="{{ route('statistics.demands.domaine.sexe.export') }}" method="POST" style="display: none;">
                            @csrf
                            <input type="date" value="{{old('dateDebut') ?? $dateDebut}}" class="form-control @error('dateDebut') is-invalid @enderror" name="dateDebut">
                            <input type="date" value="{{old('dateFin') ?? $dateFin}}" class="form-control @error('dateFin') is-invalid @enderror" name="dateFin">
                        </form>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            @include('backoffice.pages.statistic.table.dds', ['qualificationAreas' => $qualificationAreas])
                        </div>
                    </div>
                @else
