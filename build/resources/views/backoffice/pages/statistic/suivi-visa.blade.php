...
@section('content')
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                <h2 class="content-heading">Tableau de bord de suivi des visas</h2>
            </div>
        </div>
        <div class="block">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form method="Post" action="{{ route('statistics.fetch.visa.suivi') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-md-5">
                                        <div class="form-group">
                                            <label for="dateDebut" class="col-form-label">Date debut</label>
                                            <input type="date" value="{{ old('dateDebut') ?? $dateDebut }}"
                                    ...
                                    <div class="col-12 col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ old('dateFin') ?? $dateFin }}"
                ...
                @if ($isFetch)
                    @if (count($visaStats ?? []) > 0)
                        <div class="col-sm-12 col-md-6">
                            ...
                            <form id="export-excel-branche-sexe-export" action="{{ route('statistics.visa.suivi.export') }}"
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            @include('backoffice.pages.statistic.table.tsv', ['visaStats' => $visaStats])
                        </div>
                    </div>
                @else
